...
export function stringToArrayItem(str: string, arr: string[]): string | undefined {
  if (arr.length === 0) {
    return undefined
  }
...
export function resolveThemeColors(theme: ReturnType<typeof useTheme>, colorKeys: string[] = []) {
